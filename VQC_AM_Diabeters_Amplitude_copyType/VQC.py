...
class VQC(nn.Module):
    ...
    def create_qnode(self):
        ...
        def qnode(inputs, weights):
            ...
            measurements = [qml.expval(qml.PauliZ(wires=i)) for i in range(self.n_outputs)]
            print('return function qnode: ', type(measurements))
            # Measurement
            return measurements
    ...
    def apply_ansatz(self, weights):
        print('apply_ansatz weights type: ', type(weights))
    ...
    def forward(self, inputs):
        ...
        print('forward inputs type: ', type(inputs))
        print('forward inputs return type: ', type(self.qlayer(inputs)))
